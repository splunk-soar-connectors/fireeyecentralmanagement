...
This table lists the configuration variables required to operate FireEye Central Management. These variables are specified when configuring a FireEye CM asset in Splunk SOAR.
